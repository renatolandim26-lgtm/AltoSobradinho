...
export default function Testimonials() {
  ...
  const mainConsultant = contact.main;
        ...
        <div className="mx-auto max-w-5xl">
          <div className="mb-14 text-center">
            ...
            <p className="text-lg leading-relaxed text-foreground/70">
              Nossos consultores estão aqui para orientar você desde o primeiro contato até a entrega do seu imóvel.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            {/* Consultant Card */}
            <div className="relative overflow-hidden rounded-3xl shadow-2xl bg-white border border-blue-100">
              <div className="aspect-square overflow-hidden bg-gradient-to-br from-primary/20 to-blue-100">
                <img
                  src={mainConsultant.image}
                  alt={mainConsultant.name}
              ...
              <div className="p-6">
                ...
                <a
                  href={`https://wa.me/${mainConsultant.phone}?text=${encodeURIComponent(mainConsultant.defaultMessage)}`}
                  target="_blank"
                ...
                >
                  ...
                  Falar com {mainConsultant.name.split(" ")[0]}
                </a>
              </div>
            </div>
          ...
          {/* CTA Section */}
          <div className="mt-16 rounded-3xl bg-gradient-to-r from-primary to-blue-600 p-8 md:p-12 text-center text-white">
